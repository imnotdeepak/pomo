...
export function Pricing() {
	...
	return (
		<section className="relative min-h-screen overflow-hidden flex items-center px-4 md:px-6">
			<div id="pricing" className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					...
					<h2 className="font-serif mt-5 text-center text-2xl font-bold tracking-tighter md:text-3xl lg:text-4xl">
				...
				<div className="relative">
					...
					>
						<div
							className="grid md:grid-cols-2 bg-card relative border rounded-[48px] overflow-hidden p-8"
						...
						>
							...
							<div className="w-full px-4 pt-5 pb-4 relative z-10">
							...
							<div className="relative z-10 w-full rounded-lg border px-4 pt-5 pb-4">
								<BorderTrail
									style={{
										boxShadow:
